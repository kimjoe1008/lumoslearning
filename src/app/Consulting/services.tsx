...
export default function Services(){
    return(
        <div className="flex flex-col h-auto w-[90%] lg:w-full lg:items-center">
            <div className="text-4xl font-semibold mb-6 lg:w-[95%] xl:w-[86%] 2xl:w-[85%] xl:text-5xl">Services</div>
            <div className="text-lg lg:w-[95%] xl:w-[86%] 2xl:w-[85%] xl:text-xl">I provide college admissions coaching and essay coaching to high school students of all ages including:</div>
