...
export default function WhyNoah(){
    return(
        <div className="flex w-[90%] xl:w-[60%] h-auto lg:ml-10 flex-col">
            ...
            <Link href="/consultation" className="text-xl mx-2 my-12 text-center bg-white px-3 py-2 rounded-3xl inline-block">Request A Free Consultation</Link>
          </div>
    );
}