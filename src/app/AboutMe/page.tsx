                ...
                <div className="flex items-center justify-center grow mt-24">
                    <div className="flex w-3/5">
                        ...
                        <div className="w-2/3 ml-2">
                            <div className="text-7xl font-medium p-1 font-libre">Noah Kim</div>
                            <p className="text-xl p-1 font-poppins">Noah’s tutoring career started five years ago in his town’s public library helping his friends with SAT problems they were having trouble with. Four years later, he’s accumulated experience teaching students of all ages, ranging from subjects such as middle school math and english to AP Calculus and SAT.  Noah’s goal is to help people achieve their academic goals in a timeframe that works for them.
                            <br></br>
                            <br></br>
